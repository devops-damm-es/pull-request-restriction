...
test("start_IsGitReleaseSourceBranchTrue_GetGitBranchComparisonReject_ActionResultFalse_Ok", async () => {
    ...
    expect(FakeActionResultWrapperRepositoryService.Message).toBe("Pull request is not allowed: Error when obtain git comparison between release and develop branches");
});
